...
class Result:
    ...
    def unsupported(self) -> bool:
        """Exit 90 — a refusal, not a failure. The only reason to try the next tier."""
...
def route(program: str, *, binary: Path | None = None) -> Route:
...
def dispatch(
    ...
    *,
    ...
    """Route, then run, falling through on exit 90 until a tier answers.
