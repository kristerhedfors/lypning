...
def _find(p, s):
    ...
    # which is a port-patch hunk rather than a shim change — upstream-tracking
    # surface the variant deliberately does not spend (docs/BENCH-LEDGER.md,
    # the entry dated 2026-09-05, on why port-patch hunks are refused).
    #
