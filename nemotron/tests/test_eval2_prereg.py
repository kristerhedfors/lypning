...
ROOT = NEMOTRON.parent
EVAL2 = NEMOTRON / "EVAL2.md"
...
def test_relative_links_resolve_and_the_two_homes_link_back():
    ...
    for doc in ("STATUS.md", "LADDER.md"):
        assert "](EVAL2.md)" in _text(NEMOTRON / doc), doc + " must link to EVAL2.md"
...
def test_the_changelog_carries_the_entry_under_pr_79():
    ...
    assert "Pre-register eval-2 in `nemotron/EVAL2.md`" in entry
