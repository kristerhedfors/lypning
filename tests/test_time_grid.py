...
@needs_core
@pytest.mark.parametrize("program", [p for p, _ in BEFORE_IMPORT], ids=range(len(BEFORE_IMPORT)))
def test_run_directly_an_error_before_the_import_is_the_cores(program: str) -> None:
