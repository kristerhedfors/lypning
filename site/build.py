...
PAGES = [
    ...
    ("docs/STEERING.md", "docs/steering.html", "Steering", "The plan: which programs a model types that leave the subset needlessly, how to feed it the examples, and the training set and factory they become."),
